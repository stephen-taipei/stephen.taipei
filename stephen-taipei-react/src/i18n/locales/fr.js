...
export default {
  ...
  hero: {
    ...
    subtitle: 'Full Stack',
    description: 'Expérimenté dans les plateformes IA, les systèmes e-commerce, la fintech et les applications éducatives. Mise en œuvre de l\'architecture Nx Monorepo pour le partage de modules multi-projets et la maintenance à long terme, permettant plus de 100 configurations de thèmes et réduisant le code de composants complexes de 1000 à 200 lignes.',
  ...
  about: {
    ...
    description1: 'Je suis passionné par l\'apprentissage et l\'intégration interdisciplinaire. Partant d\'un parcours en design, j\'ai évolué vers la gestion de l\'information, puis me suis concentré sur le développement full-stack et l\'architecture système. Compétent en Angular et Laravel avec une expérience complète des frameworks frontend à l\'architecture backend.',
    description2: 'J\'ai dirigé une équipe de 6 personnes utilisant Git, Trello et Slack pour la gestion de projet Kanban. Réalisation réussie de plusieurs développements WebApp, accumulant une expérience pratique en analyse des besoins, planification système, collaboration et contrôle qualité du code.',
    description3: 'En dehors du travail, j\'ai fondé un studio de street dance et obtenu le titre de champion national et top 8 mondial en compétitions de danse. Ces expériences ont cultivé la persévérance, la concentration et la détermination à surmonter les défis.',
  ...
  skills: {
    ...
    subtitle: 'Un ensemble complet d\'outils pour des solutions numériques modernes',
    frontend: 'Frontend',
    backend: 'Backend',
    devops: 'DevOps',
    ai: 'Outils IA',
    ...
    projects: [
      {
        ...
        fullDesc: 'Fournit conversation et dessin IA, ainsi que des graphiques personnalisés générés par IA. Mise en œuvre du serveur WebSocket avec Laravel Swoole Octane, couplé à Angular pour la communication en temps réel, le dessin IA et le croquis en ligne. Intégration de l\'API OpenAI pour les cartes mentales, organigrammes et grilles de pensée Mandala alimentés par l\'IA.',
        tech: ['Angular PWA', 'Laravel Swoole Octane', 'WebSocket', 'OpenAI API', 'MySQL', 'Redis'],
        achievement: 'Scores Lighthouse quasi parfaits',
        features: ['Génération de cartes mentales IA', 'Génération d\'organigrammes IA', 'Grille de pensée Mandala', 'Communication en temps réel', 'Dessin IA', 'Croquis en ligne'],
      },
      {
        title: 'Meeple Logistics',
        desc: 'Système e-commerce OMO',
        fullDesc: 'Place de marché multi-vendeurs avec achats de type enchères, intégrant achats en ligne et paiements en magasin. Conception d\'algorithmes de recommandation personnalisés basés sur les traces utilisateur pour la personnalisation dynamique des pages produits.',
        tech: ['Angular PWA', 'Laravel', 'MySQL', 'Redis', 'Ubuntu', 'Nginx'],
        achievement: 'Près de 20 000 membres en un an',
        features: ['Place de marché multi-vendeurs', 'Achats type enchères', 'Système de bonus multiniveau', 'Système e-wallet', 'Intégration paiements online-offline'],
      },
      {
        title: 'StocX',
        desc: 'Système d\'entraînement boursier',
        fullDesc: 'Fournit des données historiques de prix d\'actions pour l\'entraînement au sens du marché et aux stratégies de sélection d\'actions. Optimisation de l\'hébergement mutualisé à faible coût par mise en cache et conception de processus, atteignant plus de 500 utilisateurs simultanés.',
        tech: ['Vue.js', 'Laravel', 'MySQL', 'Ubuntu', 'Apache'],
        achievement: '500 utilisateurs simultanés, partagé par des KOL et auteurs à succès',
        features: ['Analyse graphique K-line', 'Sélection d\'actions potentielles', 'Entraînement stratégique', 'Backtesting de données historiques'],
      },
      {
        title: 'Système Dermatoglyphes',
        desc: 'Plateforme de détection d\'empreintes',
        fullDesc: 'Fournit la détection d\'empreintes digitales et la génération de rapports pour enfants et parents. Comprend la gestion des étudiants, l\'analyse dermatoglyphique et la génération complète de rapports.',
        tech: ['jQuery', 'Laravel', 'MySQL', 'Ubuntu', 'Apache'],
        achievement: 'Génération automatisée de rapports',
        features: ['Gestion des étudiants', 'Analyse dermatoglyphique', 'Graphiques de fonction cérébrale', 'Export de rapports PDF'],
      },
    ],
  },
  contact: {
    title: 'Connectons-nous',
    subtitle: 'Que vous ayez une question, une idée de projet, ou simplement envie de discuter des dernières tendances tech, n\'hésitez pas à me contacter.',
    email: 'Email',
