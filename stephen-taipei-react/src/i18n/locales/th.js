...
export default {
  ...
  about: {
    ...
    description2:
      "เคยนำทีม 6 คนโดยใช้ Git (CI/CD), Trello, Slack, RedMine ในการจัดการโปรเจ็กต์ สำเร็จ Web / Android App / iOS App หลายโปรเจ็กต์ สั่งสมประสบการณ์จริงด้านวิเคราะห์ความต้องการ วางแผนระบบ การร่วมงาน และควบคุมคุณภาพโค้ด",
    description3:
    ...
    jobs: [
      {
        ...
        description: [
          ...
          "ดูแลวิศวกร frontend 2-4 คน ประสานทีมสนับสนุนหลายคน และจัดแชร์เทคนิคเป็นประจำ",
        ],
      },
      {
  ...
  tools: {
    ...
    subtitle: "เครื่องมือโอเพ่นซอร์สฟรี 8000+ รายการที่พัฒนาและดูแลร่วมกับ AI ครอบคลุม AI, เกม, เครื่องมือพัฒนา และอื่นๆ",
  ...
  openSource: {
    title: 'แพลตฟอร์มเครื่องมือโอเพ่นซอร์สของ Stephen',
    subtitle: '8 หัวข้อ · 1000+ เครื่องมือโอเพ่นซอร์ส',
    description: 'ฟรีทั้งหมด โอเพ่นซอร์ส ทำงานในเบราว์เซอร์แบบออฟไลน์ ครอบคลุมเครื่องมือ AI เกมเว็บ เครื่องมือนักพัฒนา เอฟเฟกต์ภาพและอื่นๆ',
    searchPlaceholder: 'ค้นหาหมวดหมู่เครื่องมือ...',
    backToHome: 'หน้าหลัก',
    back: 'กลับ',
    ...
    copied: 'คัดลอกแล้ว',
    refresh: 'รีเฟรช',
    previousTool: 'เครื่องมือก่อนหน้า',
    nextTool: 'เครื่องมือถัดไป',
    toolCount: '{count} เครื่องมือ',
    comingSoon: 'กำลังพัฒนา',
    free: 'ฟรีทั้งหมด',
    freeDesc: 'เครื่องมือทั้งหมดใช้งานฟรีโดยไม่ต้องลงทะเบียนหรือจ่ายเงิน',
    local: 'ทำงานในเครื่อง',
    localDesc: 'เครื่องมือทำงานในเบราว์เซอร์แบบออฟไลน์ ข้อมูลของคุณไม่ถูกส่งออก ปกป้องความเป็นส่วนตัว',
    opensource: 'การมีส่วนร่วมโอเพ่นซอร์ส',
    opensourceDesc: 'เครื่องมือทั้งหมดเป็นโอเพ่นซอร์ส ยินดีรับการมีส่วนร่วมและการปรับปรุง',
    copyrightText: '© 2024 Stephen Taipei · แพลตฟอร์มเครื่องมือโอเพ่นซอร์ส',
    github: "GitHub",
    viewAllTools: "ดูเครื่องมือทั้งหมด",
    tools: "เครื่องมือ",
  },
  ...
  awesomeApp100: {
    ...
    subtitle: '100 แอปพลิเคชัน Native ระดับพรีเมียม',
    badge: 'แพลตฟอร์มใหม่ของ Stephen',
    heading: 'แอปพลิเคชัน Native ระดับพรีเมียมที่คัดสรร',
    description: 'คอลเลกชัน 100 แอปพลิเคชัน native ระดับพรีเมียมที่คัดสรรมาสำหรับแพลตฟอร์ม iOS และ Android แต่ละแอปได้รับการคัดเลือกอย่างพิถีพิถันเพื่อคุณภาพ ประสิทธิภาพ และประสบการณ์ผู้ใช้',
    features: [
      { title: 'แอปพลิเคชัน Native', desc: 'iOS & Android' },
      { title: 'คุณภาพพรีเมียม', desc: 'คัดสรรอย่างพิถีพิถัน' },
      { title: 'ข้ามแพลตฟอร์ม', desc: 'ประสบการณ์ทุกที่' },
    ],
    cta: 'สำรวจ Awesome APP 100',
    visualText: 'แอปพรีเมียม',
    visualSubtext: 'คัดสรรเพื่อความเป็นเลิศ',
  },
