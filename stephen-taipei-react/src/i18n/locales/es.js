...
export default {
  ...
  hero: {
    ...
    subtitle: 'Full Stack',
    description: 'Experiencia en plataformas de IA, sistemas de comercio electrónico, fintech y aplicaciones educativas. Implementé arquitectura Nx Monorepo para compartir módulos entre proyectos y mantenimiento a largo plazo, habilitando más de 100 configuraciones de temas y reduciendo código de componentes complejos de 1000 a 200 líneas.',
  ...
  about: {
    ...
    description3: 'Fuera del trabajo, fundé un estudio de street dance y logré campeón nacional y top 8 mundial en competencias de baile. Estas experiencias cultivaron perseverancia, enfoque y determinación para superar desafíos.',
  ...
  portfolio: {
    ...
    projects: [
      ...
      },
      {
        ...
        fullDesc: 'Proporciona detección de huellas dactilares y generación de informes para niños y padres. Incluye gestión de estudiantes, análisis dermatoglífico y generación completa de informes.',
        tech: ['jQuery', 'Laravel', 'MySQL', 'Ubuntu', 'Apache'],
        achievement: 'Generación automatizada de informes',
        features: ['Gestión de Estudiantes', 'Análisis Dermatoglífico', 'Gráficos de Función Cerebral', 'Exportación de Informes PDF'],
      },
    ],
  },
  contact: {
    title: 'Conectemos',
    subtitle: 'Ya sea que tenga una pregunta, una idea de proyecto o simplemente quiera discutir las últimas tendencias tecnológicas, no dude en contactarme.',
    email: 'Correo',
    location: 'Ubicación',
