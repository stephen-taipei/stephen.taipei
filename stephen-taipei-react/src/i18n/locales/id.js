...
export default {
  ...
  hero: {
    ...
    subtitle: 'Engineer',
    description: 'Berpengalaman dalam platform AI, sistem e-commerce, fintech, dan aplikasi pendidikan. Mengimplementasikan arsitektur Nx Monorepo untuk berbagi modul multi-proyek dan pemeliharaan jangka panjang, memungkinkan 100+ konfigurasi tema dan mengurangi kode komponen kompleks dari 1000 menjadi 200 baris.',
  ...
  about: {
    ...
    description1: 'Saya bersemangat tentang pembelajaran dan integrasi lintas domain. Dari latar belakang desain, saya beralih ke manajemen informasi, dan akhirnya fokus pada pengembangan full-stack dan arsitektur sistem. Mahir dalam Angular dan Laravel dengan pengalaman pengembangan lengkap dari framework frontend hingga arsitektur backend.',
    description2: 'Memimpin tim 6 orang menggunakan Git, Trello, dan Slack untuk manajemen proyek gaya Kanban. Berhasil menyelesaikan beberapa pengembangan WebApp, mengumpulkan pengalaman praktis dalam analisis kebutuhan, perencanaan sistem, kolaborasi, dan kontrol kualitas kode.',
    description3: 'Di luar pekerjaan, saya mendirikan studio street dance dan meraih juara nasional serta top 8 dunia dalam kompetisi tari. Pengalaman ini menumbuhkan ketekunan, fokus, dan tekad untuk mengatasi tantangan.',
    ...
    projects: [
      {
        ...
        fullDesc: 'Menyediakan percakapan dan gambar AI, bersama dengan grafik kustom yang dihasilkan AI. Mengimplementasikan WebSocket Server dengan Laravel Swoole Octane, dipasangkan dengan Angular untuk komunikasi real-time, gambar AI, dan sketsa online. Mengintegrasikan OpenAI API untuk peta pikiran, diagram alur, dan grid pemikiran Mandala berbasis AI.',
        tech: ['Angular PWA', 'Laravel Swoole Octane', 'WebSocket', 'OpenAI API', 'MySQL', 'Redis'],
        achievement: 'Skor Lighthouse hampir sempurna',
        features: ['Pembuatan Peta Pikiran AI', 'Pembuatan Diagram Alur AI', 'Grid Pemikiran Mandala', 'Komunikasi Real-time', 'Gambar AI', 'Sketsa Online'],
      },
      {
        title: 'Meeple Logistics',
        desc: 'Sistem E-commerce OMO',
        fullDesc: 'Marketplace multi-vendor dengan belanja gaya lelang, mengintegrasikan belanja online dan pembayaran toko offline. Merancang algoritma rekomendasi personal berdasarkan jejak pengguna untuk kustomisasi halaman produk dinamis.',
        tech: ['Angular PWA', 'Laravel', 'MySQL', 'Redis', 'Ubuntu', 'Nginx'],
        achievement: 'Hampir 20.000 anggota dalam satu tahun',
        features: ['Marketplace Multi-vendor', 'Belanja Gaya Lelang', 'Sistem Bonus Multi-tier', 'Sistem E-wallet', 'Integrasi Pembayaran Online-Offline'],
      },
      {
        title: 'StocX',
        desc: 'Sistem Pelatihan Pasar Saham',
        fullDesc: 'Menyediakan data harga saham historis untuk melatih sense pasar dan strategi pemilihan saham. Mengoptimalkan hosting bersama berbiaya rendah melalui caching dan desain proses, mencapai 500+ pengguna bersamaan.',
        tech: ['Vue.js', 'Laravel', 'MySQL', 'Ubuntu', 'Apache'],
        achievement: '500 pengguna bersamaan, dibagikan oleh KOL & penulis bestseller',
        features: ['Analisis Grafik K-line', 'Penyaringan Saham Potensial', 'Pelatihan Strategi', 'Backtesting Data Historis'],
      },
      {
        title: 'Sistem Dermatoglyphics',
        desc: 'Platform Deteksi Sidik Jari',
        fullDesc: 'Menyediakan deteksi sidik jari dan pembuatan laporan untuk anak-anak dan orang tua. Termasuk manajemen siswa, analisis dermatoglyphic, dan pembuatan laporan komprehensif.',
        tech: ['jQuery', 'Laravel', 'MySQL', 'Ubuntu', 'Apache'],
        achievement: 'Pembuatan laporan otomatis',
        features: ['Manajemen Siswa', 'Analisis Dermatoglyphic', 'Grafik Fungsi Otak', 'Ekspor Laporan PDF'],
      },
    ],
  },
  contact: {
    title: 'Mari Terhubung',
    subtitle: 'Baik Anda memiliki pertanyaan, ide proyek, atau hanya ingin mendiskusikan tren teknologi terbaru, jangan ragu untuk menghubungi.',
    email: 'Email',
    location: 'Lokasi',
