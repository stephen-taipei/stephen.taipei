...
export default {
  ...
  about: {
    ...
    description1: 'Sono appassionato di apprendimento e integrazione cross-domain. Partendo da un background nel design, sono passato alla gestione delle informazioni e infine mi sono concentrato sullo sviluppo full-stack e l\'architettura di sistema. Competente in Angular e Laravel con esperienza di sviluppo completa dai framework frontend all\'architettura backend.',
    description2: 'Ho guidato un team di 6 persone utilizzando Git, Trello e Slack per la gestione progetti in stile Kanban. Ho completato con successo diversi sviluppi WebApp, accumulando esperienza pratica in analisi dei requisiti, pianificazione di sistema, collaborazione e controllo qualità del codice.',
    description3: 'Al di fuori del lavoro, ho fondato uno studio di street dance e ho raggiunto il titolo di campione nazionale e top 8 mondiale nelle competizioni di danza. Queste esperienze hanno coltivato perseveranza, concentrazione e determinazione nel superare le sfide.',
    ...
    projects: [
      {
        ...
        fullDesc: 'Fornisce conversazione e disegno AI, insieme a grafici personalizzati generati da AI. Implementato WebSocket Server con Laravel Swoole Octane, abbinato ad Angular per comunicazione real-time, disegno AI e sketching online. Integrata OpenAI API per mappe mentali, diagrammi di flusso e griglie di pensiero Mandala alimentati da AI.',
        tech: ['Angular PWA', 'Laravel Swoole Octane', 'WebSocket', 'OpenAI API', 'MySQL', 'Redis'],
        achievement: 'Punteggi Lighthouse quasi perfetti',
        features: ['Generazione Mappe Mentali AI', 'Generazione Diagrammi di Flusso AI', 'Griglia di Pensiero Mandala', 'Comunicazione Real-time', 'Disegno AI', 'Sketching Online'],
      },
      {
        title: 'Meeple Logistics',
        desc: 'Sistema E-commerce OMO',
        fullDesc: 'Marketplace multi-vendor con shopping stile asta, integrazione di shopping online e pagamenti in negozio offline. Progettati algoritmi di raccomandazione personalizzati basati sulle impronte utente per la personalizzazione dinamica delle pagine prodotto.',
        tech: ['Angular PWA', 'Laravel', 'MySQL', 'Redis', 'Ubuntu', 'Nginx'],
        achievement: 'Quasi 20.000 membri in un anno',
        features: ['Marketplace Multi-vendor', 'Shopping Stile Asta', 'Sistema Bonus Multi-livello', 'Sistema E-wallet', 'Integrazione Pagamenti Online-Offline'],
      },
      {
        title: 'StocX',
        desc: 'Sistema di Training Mercato Azionario',
        fullDesc: 'Fornisce dati storici sui prezzi delle azioni per allenare il senso del mercato e le strategie di selezione titoli. Ottimizzato hosting condiviso a basso costo attraverso caching e design dei processi, raggiungendo oltre 500 utenti simultanei.',
        tech: ['Vue.js', 'Laravel', 'MySQL', 'Ubuntu', 'Apache'],
        achievement: '500 utenti simultanei, condiviso da KOL e autori bestseller',
        features: ['Analisi Grafici K-line', 'Screening Titoli Potenziali', 'Training Strategico', 'Backtesting Dati Storici'],
      },
      {
        title: 'Sistema Dermatoglifi',
        desc: 'Piattaforma Rilevamento Impronte',
        fullDesc: 'Fornisce rilevamento impronte digitali e generazione report per bambini e genitori. Include gestione studenti, analisi dermatoglifica e generazione report completa.',
        tech: ['jQuery', 'Laravel', 'MySQL', 'Ubuntu', 'Apache'],
        achievement: 'Generazione report automatizzata',
        features: ['Gestione Studenti', 'Analisi Dermatoglifica', 'Grafici Funzioni Cerebrali', 'Esportazione Report PDF'],
      },
    ],
  },
  contact: {
    title: 'Connettiamoci',
    subtitle: 'Che tu abbia una domanda, un\'idea di progetto, o semplicemente voglia discutere delle ultime tendenze tech, non esitare a contattarmi.',
    email: 'Email',
    location: 'Posizione',
