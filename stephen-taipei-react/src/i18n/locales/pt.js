...
export default {
    ...
    projects: [
      {
        ...
        features: ['Geração de mapa mental com IA', 'Geração de fluxograma com IA', 'Grelha Mandala', 'Comunicação em tempo real', 'Desenho com IA', 'Esboço online'],
      },
      {
        ...
        features: ['Marketplace multi-vendedor', 'Compras em estilo de leilão', 'Bónus em vários níveis', 'Carteira digital', 'Integração de pagamento online e offline'],
      },
      {
        title: 'StocX',
        ...
        achievement: '500 utilizadores simultâneos, divulgado por KOLs e autores best-seller',
        features: ['Análise de gráficos de velas', 'Seleção de ações potenciais', 'Treino de estratégias', 'Backtesting de dados históricos'],
      },
      {
        ...
        features: ['Gestão de estudantes', 'Análise de dermatoglifos', 'Gráficos de funções cerebrais', 'Exportação de relatórios em PDF'],
      },
    ],
  },
  ...
  contact: {
    title: 'Contacte-me',
    subtitle: 'Tem uma questão ou uma ideia de projeto? Sinta-se à vontade para falar comigo.',
    email: 'Email',
