...
export default {
  ...
  about: {
    ...
    description2:
      "Liderei uma equipa de 6 pessoas usando Git (CI/CD), Trello, Slack e RedMine para gestão de projetos. Concluí vários desenvolvimentos de Web / Android App / iOS App, acumulando experiência prática em análise de requisitos, planeamento de sistemas, colaboração e controlo de qualidade de código.",
    description3:
    ...
    jobs: [
      {
        ...
        description: [
          ...
          "Gestão direta de 2-4 engenheiros frontend, coordenação indireta de vários membros de apoio e sessões regulares de partilha técnica.",
        ],
      },
      {
  ...
  openSource: {
    ...
    description: "Completamente gratuito, open source, a correr localmente no seu navegador. Cobrindo ferramentas de IA, jogos web, ferramentas de desenvolvimento, efeitos visuais e muito mais.",
    ...
    freeDesc: "Todas as ferramentas são completamente gratuitas, sem necessidade de registo ou pagamento",
    local: "Execução local",
    localDesc: "As ferramentas são executadas localmente no seu navegador, os seus dados não são transmitidos, protegendo a sua privacidade",
  ...
  awesomeApp100: {
    ...
    subtitle: '100 Aplicações Nativas Premium',
    badge: 'Nova Plataforma do Stephen',
    heading: 'Aplicações Nativas Premium Selecionadas',
    description: 'Uma coleção de 100 aplicações nativas premium selecionadas para plataformas iOS e Android. Cada aplicação foi cuidadosamente escolhida pela sua qualidade, desempenho e experiência do utilizador.',
    features: [
      { title: 'Apps Nativas', desc: 'iOS & Android' },
      { title: 'Qualidade Premium', desc: 'Cuidadosamente Selecionadas' },
      { title: 'Multiplataforma', desc: 'Experiência Universal' },
    ],
    cta: 'Explorar Awesome APP 100',
    visualText: 'Apps Premium',
    visualSubtext: 'Selecionadas pela Excelência',
  },
