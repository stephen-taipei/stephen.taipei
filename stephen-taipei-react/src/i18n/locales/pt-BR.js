...
export default {
  ...
  about: {
    ...
    description2:
      'Liderei uma equipe de 6 pessoas utilizando Git, Trello e Slack em um fluxo Kanban. Concluí vários desenvolvimentos de WebApp, acumulando experiência prática em análise de requisitos, planejamento de sistemas, colaboração e qualidade de código.',
    description3:
    ...
    jobs: [
      {
        ...
        description: [
          ...
          'Gestão direta de 2-4 engenheiros frontend, coordenação indireta de 6 membros de suporte e sessões técnicas regulares.',
        ],
      },
      {
    ...
    projects: [
      {
        ...
        features: ['Geração de mapa mental com IA', 'Geração de fluxograma com IA', 'Grade Mandala', 'Comunicação em tempo real', 'Desenho com IA', 'Esboço online'],
      },
      {
        ...
        features: ['Marketplace multivendedor', 'Compras em estilo leilão', 'Sistema de bônus em camadas', 'Carteira digital', 'Integração de pagamento online e offline'],
      },
      {
        title: 'StocX',
        ...
        achievement: '500 usuários simultâneos, divulgado por KOLs e autores best-seller',
        features: ['Análise de gráficos de velas', 'Triagem de ações potenciais', 'Treino de estratégias', 'Backtesting com dados históricos'],
      },
      {
        ...
        features: ['Gestão de estudantes', 'Análise dermatoglífica', 'Gráficos de funções cerebrais', 'Exportação de relatórios em PDF'],
      },
    ],
  },
  ...
  contact: {
    ...
    subtitle: 'Tem uma pergunta, uma ideia de projeto ou quer falar sobre tecnologia? Sinta-se à vontade para me chamar.',
    email: 'Email',
