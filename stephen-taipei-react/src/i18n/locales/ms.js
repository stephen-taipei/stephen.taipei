...
export default {
    ...
    projects: [
      {
        ...
        features: [
          "Janakuasa peta minda AI",
          "Janakuasa carta alir AI",
          "Grid Mandala",
          "Komunikasi masa nyata",
          "Lukisan AI",
          "Lakaran dalam talian",
        ],
      },
      {
        ...
        features: [
          "Marketplace pelbagai penjual",
          "Belian gaya lelong",
          "Sistem bonus berlapis",
          "Dompet elektronik",
      ...
      },
      {
        ...
        achievement:
          "500 pengguna serentak, dikongsi oleh KOL dan penulis terlaris",
        features: [
          "Analisis carta lilin",
          "Tapis saham berpotensi",
          "Latihan strategi",
          "Ujian semula data sejarah",
        ],
      },
      {
  ...
  tools: {
    ...
    subtitle: "8000+ alat sumber terbuka percuma yang dibangunkan dan diselenggara bersama AI, merangkumi AI, permainan, alat pembangunan dan banyak lagi",
